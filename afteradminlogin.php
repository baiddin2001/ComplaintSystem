...
<html>
  ...
  <body>
		...
		<nav class="navbar-nav navbar-expand-sm bg-warning" style="margin:0px;padding:0px;">
		
<i class="fa fa-reorder" onclick="callsh()" style="cursor:pointer;font-size:24px;margin:20px 2px 0px 20px;color:black"></i>
		<div class="nav-item item1" style="margin-left:5%">
		<img src="admin1.png" style="border-radius:15%;margin-left:0%;float:left" width="90px" height="90px">
				<h3  style="float:left;cursor:pointer;margin:25px 2px 0px 20px;">Admin</h3>
