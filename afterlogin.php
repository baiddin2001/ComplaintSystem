...
<html>
  ...
  <link rel="stylesheet" href="main.css">
	...
	<body>
				<nav class="navbar-nav nav2 navbar-expand-sm bg-warning">
		
<i class="fa fa-reorder" onclick="callsh()" style="cursor:pointer;font-size:24px;margin:10px 2px 0px 20px;color:black"></i>		
		<div class="nav-item item1" style="margin-left:5%">
		<h3 style="color:dark"><?php echo $fname." ".$lname; ?></h3>
		</div>
		
	
			<div class="nav-item items"  style="margin-left:60%;">
		...
		<nav  class="navbar navbar1 bg-light" style="float:left;margin-top:0px;display:block;
			...
			<!-- Links -->
  <ul class="navbar-nav" style="width:100%;background-color:#f09d50b9;">
			  <li class="nav-item" >			
		<img src="client.png" width="90px" height="80px">
		   </li>
    <li class="nav-item"  >
